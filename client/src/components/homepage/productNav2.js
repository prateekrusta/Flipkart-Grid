...
const ProductsNav = () => {
  return (
    <div className='productNav' style={{marginTop:'5%'}}>
      <div className="heading"><img alt="" src={Star} className='nav-links-img'  style={{height:'35%', marginRight:'10px', position:'relative', top:'-5px'}} /><h2 style={{textAlign:'left', color:'black'}}>Results</h2></div>
